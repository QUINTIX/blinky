...
static void
__rb_rotate_left(struct redblack_node *node, struct rb_root *root)
{
    struct redblack_node *right = node->rb_right;
...
static void
__rb_rotate_right(struct redblack_node *node, struct rb_root *root)
{
    struct redblack_node *left = node->rb_left;
...
void
rb_insert_color(struct redblack_node *node, struct rb_root *root)
{
	...
	if (parent == gparent->rb_left) {
	    {
		register struct redblack_node *uncle = gparent->rb_right;
	    ...
	    {
		register struct redblack_node *uncle = gparent->rb_left;
		if (uncle && uncle->rb_color == QRB_RED) {
		    uncle->rb_color = QRB_BLACK;
		    parent->rb_color = QRB_BLACK;
		    gparent->rb_color = QRB_RED;
    ...
    root->redblack_node->rb_color = QRB_BLACK;
}


static void
__rb_erase_color(struct redblack_node *node, struct redblack_node *parent, struct rb_root *root)
{
    struct redblack_node *other;

    while ((!node || node->rb_color == QRB_BLACK) && node != root->redblack_node) {
	if (parent->rb_left == node) {
...
void
rb_erase(struct redblack_node *node, struct rb_root *root)
{
